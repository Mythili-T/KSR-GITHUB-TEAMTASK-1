...
var userMail = "kiran2023@gmail.com";
var userPassword = "Kiran2023!";
...
function userMailValidate() {
    ...
    if (userEnteredMail.trim() != mail && userEnteredMail.trim() != userMail) {
        return false;
    }
...
function userPasswordValidate() {
    ...
    if (userpassword.trim() != password && userpassword.trim() != userPassword) {
        return false;
    }
